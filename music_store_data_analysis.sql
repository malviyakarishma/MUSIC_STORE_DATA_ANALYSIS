/*Que 1 Who is the most senior employee based on job title?*/
...
select count(*) as c , SUM(total) as Invoice_Total , billing_city from invoice
...
select customer.first_name , customer.last_name , sum(total) as total_spending from customer
...
select distinct email as Email , first_name as FirstName , last_name as LastName from customer
